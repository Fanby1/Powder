...
def args_parser():
    ...
    parser.add_argument('--numclass', type=int, default=100, help="number of classes in FCL process")
    ...
    parser.add_argument('--num_clients', type=int, default=1, help='initial number of clients')
